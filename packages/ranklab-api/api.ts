...
export const DefaultApiFp = function (configuration?: Configuration) {
  return {
    ...
    getHealth(
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<Health> {
 ...
 * @export
 */
export const RanklabApiFetchParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    coachesCreate(body: CreateCoachRequest, options: any = {}): FetchArgs {
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling coachesCreate."
        )
      }
    ...
    commentsCreate(body: CreateCommentRequest, options: any = {}): FetchArgs {
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling commentsCreate."
        )
      }
    ...
    reviewsCreate(body: CreateReviewRequest, options: any = {}): FetchArgs {
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling reviewsCreate."
        )
      }
      ...
      const needsSerialization =
        <any>"CreateReviewRequest" !== "string" ||
        localVarRequestOptions.headers["Content-Type"] === "application/json"
      localVarRequestOptions.body = needsSerialization
        ? JSON.stringify(body || {})
        : body || ""
    ...
    reviewsGet(id: string, options: any = {}): FetchArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling reviewsGet."
        )
      }
      const localVarPath = `/reviews/{id}`.replace(
        `{${"id"}}`,
...
export const RanklabApiFp = function (configuration?: Configuration) {
  return {
    ...
    coachesCreate(
      ...
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<Coach> {
      const localVarFetchArgs = RanklabApiFetchParamCreator(
        configuration
      ).coachesCreate(body, options)
      return (
        fetch: FetchAPI = isomorphicFetch,
        basePath: string = BASE_PATH
      ) => {
    ...
    commentsCreate(
      ...
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<Comment> {
      const localVarFetchArgs = RanklabApiFetchParamCreator(
        configuration
      ).commentsCreate(body, options)
      return (
        fetch: FetchAPI = isomorphicFetch,
        basePath: string = BASE_PATH
      ) => {
    ...
    recordingsCreate(
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<Recording> {
      const localVarFetchArgs =
        RanklabApiFetchParamCreator(configuration).recordingsCreate(options)
      return (
        fetch: FetchAPI = isomorphicFetch,
        basePath: string = BASE_PATH
      ) => {
    ...
    reviewsCreate(
      ...
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<Review> {
      const localVarFetchArgs = RanklabApiFetchParamCreator(
        configuration
      ).reviewsCreate(body, options)
      return (
        fetch: FetchAPI = isomorphicFetch,
        basePath: string = BASE_PATH
      ) => {
    ...
    reviewsList(
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Review>> {
      const localVarFetchArgs =
        RanklabApiFetchParamCreator(configuration).reviewsList(options)
      return (
        fetch: FetchAPI = isomorphicFetch,
        basePath: string = BASE_PATH
      ) => {
    ...
    usersGetCurrent(
      ...
      const localVarFetchArgs =
        RanklabApiFetchParamCreator(configuration).usersGetCurrent(options)
      return (
        fetch: FetchAPI = isomorphicFetch,
        basePath: string = BASE_PATH
      ) => {
 ...
 * @export
 */
export const RanklabApiFactory = function (
  configuration?: Configuration,
  fetch?: FetchAPI,
  basePath?: string
) {
  return {
    ...
    coachesCreate(body: CreateCoachRequest, options?: any) {
      return RanklabApiFp(configuration).coachesCreate(body, options)(
        fetch,
        basePath
      )
    },
    ...
    commentsCreate(body: CreateCommentRequest, options?: any) {
      return RanklabApiFp(configuration).commentsCreate(body, options)(
        fetch,
        basePath
      )
    },
    ...
    recordingsCreate(options?: any) {
      return RanklabApiFp(configuration).recordingsCreate(options)(
        fetch,
        basePath
      )
    },
    ...
    reviewsCreate(body: CreateReviewRequest, options?: any) {
      return RanklabApiFp(configuration).reviewsCreate(body, options)(
        fetch,
        basePath
      )
    },
    ...
    reviewsGet(id: string, options?: any) {
      return RanklabApiFp(configuration).reviewsGet(id, options)(
        fetch,
        basePath
      )
    },
    ...
    usersGetCurrent(options?: any) {
      return RanklabApiFp(configuration).usersGetCurrent(options)(
        fetch,
        basePath
      )
    },
...
export class RanklabApi extends BaseAPI {
  ...
  public coachesCreate(body: CreateCoachRequest, options?: any) {
    return RanklabApiFp(this.configuration).coachesCreate(body, options)(
      this.fetch,
      this.basePath
    )
  }
  ...
  public commentsCreate(body: CreateCommentRequest, options?: any) {
    return RanklabApiFp(this.configuration).commentsCreate(body, options)(
      this.fetch,
      this.basePath
    )
  }
  ...
  public recordingsCreate(options?: any) {
    return RanklabApiFp(this.configuration).recordingsCreate(options)(
      this.fetch,
      this.basePath
    )
  }
  ...
  public reviewsCreate(body: CreateReviewRequest, options?: any) {
    return RanklabApiFp(this.configuration).reviewsCreate(body, options)(
      this.fetch,
      this.basePath
    )
  }
  ...
  public reviewsGet(id: string, options?: any) {
    return RanklabApiFp(this.configuration).reviewsGet(id, options)(
      this.fetch,
      this.basePath
    )
  }
  ...
  public reviewsList(options?: any) {
    return RanklabApiFp(this.configuration).reviewsList(options)(
      this.fetch,
      this.basePath
    )
  }
  ...
  public usersGetCurrent(options?: any) {
    return RanklabApiFp(this.configuration).usersGetCurrent(options)(
      this.fetch,
      this.basePath
    )
  }
