...
import { CartItem } from "../CheckoutForm"
import { Iconify } from "@/components/Iconify"
import { CheckoutFormTableHead } from "./TableHead"
...
export function CheckoutFormProductList({
  products,
  onDelete,
  onIncreaseQuantity,
  onDecreaseQuantity,
  ...
  return (
    <TableContainer sx={{ minWidth: 720 }}>
      <Table>
        <CheckoutFormTableHead headLabel={TABLE_HEAD} />
...
function CheckoutProductListRow({
  ...
  return (
    <TableRow>
      ...
      <TableCell align="right">{formatPrice(price * quantity)}</TableCell>
